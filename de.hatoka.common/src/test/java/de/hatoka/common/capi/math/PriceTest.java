...
public class PriceTest
{
    ...
    private static final Price PRICE_10_EUR_PER_KILO = new Price(Money.valueOf(BigDecimal.TEN, CurrencyConstants.EUR),
                    ONE_KILO_GRAM);
    private static final Price PRICE_7_EUR_PER_SEVEN_HUNDED_GRAM = new Price(
                    Money.valueOf(new BigDecimal("7"), CurrencyConstants.EUR), SEVEN_HUNDRED_GRAM);
