...
public class Money
{
    public static final Comparator<Money> COMPARATOR = new Comparator<Money>()
    {
        ...
        public int compare(Money o1, Money o2)
        {
            ...
            return o1.subtract(o2).getAmount().intValue();
        }
    };
    ...
    public static Money valueOf(String amount)
    {
        ...
        int lastSpace = amount.lastIndexOf(" ");
        return valueOf(amount.substring(0, lastSpace), amount.substring(lastSpace + 1));
    }
    ...
    /**
     * Divide the amount with an additional scale of 4. (e.g. 10.divide(3) ==
     * 3.3333)
     *
     * @param divisor
    ...
    public Money divide(BigDecimal divisor, int additionalScale)
    {
        ...
        return new Money(amount.setScale(getPositiveScale(amount) + getPositiveScale(divisor) + additionalScale)
                        .divide(divisor, RoundingMode.HALF_EVEN), currency);
    }
    ...
    /**
     * @return Returns a string representation of the object. The string is convertible to money via {@link Money#valueOf(String)}.
     */
    @Override
    @JsonValue
