...
import de.hatoka.tournament.internal.config.TournamentConfigurationImpl;
...
public class TournamentBusinessModule implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(TournamentConfiguration.class).to(TournamentConfigurationImpl.class).asEagerSingleton();
    }
}
